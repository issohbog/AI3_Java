...
public class NumberFormat {
	public static void main(String[] args) {
		...
		System.out.println("numberStirng + 5 = " + (numberString + 5));
		...
		try {
			num2 = Integer.parseInt(numberAndString);	//(에외발생) NumberFormatException
		} catch (NumberFormatException e) {				//위에서 예외 발생시 아래 catch 블럭으로 이동 

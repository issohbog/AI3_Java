...
public class CalendarEx {
	...
	public static void main(String[] args) {
		...
		// 자바 프로그래밍 마지막 수업일
		Calendar test = Calendar.getInstance();		// 싱글톤패턴 적용되어 객체 하나만 생성되도록 하는 메소드 getInstance(); 			
		...
		System.out.println("lastT - nowT = " + (lastT - nowT));	// 종강일의 밀리초 숫자- 현재 밀리초 숫자
		
		
		long dDay = (lastT - nowT) / (1000 * 60 * 60 * 24);		// 뺀값(밀리초)를 일로 환산 
		...
		birth.set( 1999, Calendar.SEPTEMBER, 25 );		// 내 생일로 날짜 지정하기 : 2000/08/22
